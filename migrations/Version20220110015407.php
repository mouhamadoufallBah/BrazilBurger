 ...
 */
final class Version20220110015407 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE complement ADD burger_id INT DEFAULT NULL, ADD menu_id INT DEFAULT NULL');
